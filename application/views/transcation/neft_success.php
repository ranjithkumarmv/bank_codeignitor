	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="page-header">
				<center><h4>NEFT Transcation Successfull</h4></center><br>
			</div>
			<p>From Account No:<b><?php echo $myaccount['accountno']; ?></b><br>
			TO Account No:<b><?php echo $toaccount; ?></b><br>
			TO User Name:<b><?php echo $touser; ?></b><br>
			NEFT Amount Rs:<b><?php echo $neft_amount; ?></b><br>
